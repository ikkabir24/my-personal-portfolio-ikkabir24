                        ...
                        <div className="flex flex-col gap-12">
                            <div className="flex flex-col gap-6">
                                ...
                                <FadeIn delay={300}>
                                    ...
                                    className='inline-flex items-center gap-3 bg-white hover:bg-white/90 text-black rounded-full px-8 py-4 text-base font-medium transition-all duration-300 group'>
